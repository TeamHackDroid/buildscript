...
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ancora_tmo_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ancora_tmo_oc_exuv_hm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ancora_tmo_oc_exuv_sm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ancora_tmo_oc_exuv_vhm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ancora_tmo_oc_uv_hm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ancora_tmo_oc_uv_sm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ancora_tmo_oc_uv_vhm_defconfig/
...
java -jar signapk.jar ~/kernel/kernel tools/testkey.x509.pem ~/kernel/kernel tools/testkey.pk8 <KKernel-`date +%Y%m%d_%H%M`-oc-exuv-hm.zip> <KKernel-`date +%Y%m%d_%H%M`-oc-exuv-hm_signed.zip>
