...
cp -avr ~/kernel/kerneltools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_defconfig/
cp -avr ~/kernel/kerneltools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_exuv_hm_defconfig/
cp -avr ~/kernel/kerneltools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_exuv_sm_defconfig/
cp -avr ~/kernel/kerneltools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_exuv_vhm_defconfig/
cp -avr ~/kernel/kerneltools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_uv_hm_defconfig/
cp -avr ~/kernel/kerneltools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_uv_sm_defconfig/
cp -avr ~/kernel/kerneltools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_uv_vhm_defconfig/
...
#java -jar ~/kernel/kerneltools/signapk.jar ~/kernel/kerneltools/testkey.x509.pem ~/kernel/kerneltools/testkey.pk8 KKernel-`date +%Y%m%d`-oc-uv-xhm KKernel-`date +%Y%m%d`-oc-uv-xhm_signed.zip
