...
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_exuv_hm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_exuv_sm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_exuv_vhm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_uv_hm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_uv_sm_defconfig/
cp -avr ~/kernel/kernel tools/flash scripts/KKernel ~/kernel/KKernel/temp/ariesve_oc_uv_vhm_defconfig/
...
cp -avr ~/kernel/kernel tools/flash scripts/adc ~/kernel/ADC/temp/ariesve_defconfig/
...
make clean
cd ~/kernel/kernel tools/
mkbootimg --kernel ~/kernel/KKernel/temp/ariesve_oc_exuv_sm_defconfig/zImage --ramdisk ~/kernel/initramfs.cpio.gz --base 0x00400000 --pagesize 4096 --cmdline 'init=/sbin/init root=/dev/ram rw initrd=0x11000000,16M console=ttyDCC0 mem=88M ip=dhcp' -o ~/kernel/KKernel/temp/ariesve_oc_exuv_sm_defconfig/boot.img
...
make clean
cd ~/kernel/kernel tools/
mkbootimg --kernel ~/kernel/KKernel/temp/ariesve_oc_exuv_vhm_defconfig/zImage --ramdisk ~/kernel/initramfs.cpio.gz --base 0x00400000 --pagesize 4096 --cmdline 'init=/sbin/init root=/dev/ram rw initrd=0x11000000,16M console=ttyDCC0 mem=88M ip=dhcp' -o ~/kernel/KKernel/temp/ariesve_oc_exuv_vhm_defconfig/boot.img
...
make clean
cd ~/kernel/kernel tools/
mkbootimg --kernel ~/kernel/KKernel/temp/ariesve_oc_uv_hm_defconfig/zImage --ramdisk ~/kernel/initramfs.cpio.gz --base 0x00400000 --pagesize 4096 --cmdline 'init=/sbin/init root=/dev/ram rw initrd=0x11000000,16M console=ttyDCC0 mem=88M ip=dhcp' -o ~/kernel/KKernel/temp/ariesve_oc_uv_hm_defconfig/boot.img
...
make clean
cd ~/kernel/kernel tools/
mkbootimg --kernel ~/kernel/KKernel/temp/ariesve_oc_uv_sm_defconfig/zImage --ramdisk ~/kernel/initramfs.cpio.gz --base 0x00400000 --pagesize 4096 --cmdline 'init=/sbin/init root=/dev/ram rw initrd=0x11000000,16M console=ttyDCC0 mem=88M ip=dhcp' -o ~/kernel/KKernel/temp/ariesve_oc_uv_sm_defconfig/boot.img
...
#java -jar ~/kernel/kernel tools/signapk.jar ~/kernel/kernel tools/testkey.x509.pem ~/kernel/kernel tools/testkey.pk8 <KKernel-`date +%Y%m%d_%H%M`-oc-uv-xhm> <KKernel-`date +%Y%m%d_%H%M`-oc-uv-xhm_signed.zip>
