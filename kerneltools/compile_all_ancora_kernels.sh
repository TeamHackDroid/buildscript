...
mkdir -p ~/kernel/ADC/temp/ancora_defconfig/
...
mkdir -p ~/kernel/ADC/temp/ancora_defconfig/system/modules
cp -avr ~/kernel/kerneltools/flash scripts/adc ~/kernel/ADC/temp/ancora_defconfig/
...
zip -r KKernel-`date +%Y%m%d`-oc.zip ~/kernel/KKernel/temp/ancora_defconfig
...
zip -r KKernel-`date +%Y%m%d`-oc-exuv-hm.zip ~/kernel/KKernel/temp/ancora_oc_exuv_hm_defconfig
...
zip -r KKernel-`date +%Y%m%d`-oc-exuv-sm.zip ~/kernel/KKernel/temp/ancora_oc_exuv_sm_defconfig
...
zip -r KKernel-`date +%Y%m%d`-oc-exuv-vhm.zip ~/kernel/KKernel/temp/ancora_oc_exuv_vhm_defconfig
...
#zip -r KKernel-`date +%Y%m%d`-oc-exuv-xhm.zip ~/kernel/KKernel/temp/ancora_oc_exuv_xhm_defconfig
...
zip -r KKernel-`date +%Y%m%d`-oc-uv-hm.zip ~/kernel/KKernel/temp/ancora_oc_uv_hm_defconfig
...
zip -r KKernel-`date +%Y%m%d`-oc-uv-sm.zip ~/kernel/KKernel/temp/ancora_oc_uv_sm_defconfig
...
zip -r KKernel-`date +%Y%m%d`-oc-uv-vhm.zip ~/kernel/KKernel/temp/ancora_oc_uv_vhm_defconfig
...
#zip -r KKernel`date +%Y%m%d`-oc-uv-xhm.zip ~/kernel/KKernel/temp/ancora_oc_uv_xhm_defconfig
...
zip -r ADCKernel-`date +%Y%m%d`-oc.zip ~/kernel/KKernel/temp/ancora_defconfig
